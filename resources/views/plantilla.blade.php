...
<body class="bg-slate-100 text-gray-800 min-h-screen flex">

  <!-- Sidebar -->
  <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-40">
    <div class="flex flex-col h-full">

      <div class="px-6 py-6 text-center border-b border-white/10">
        <img src="{{ asset('imagenes/logo1.png') }}" class="w-20 mx-auto mb-2" />
  ...
  <div class="flex-1 flex flex-col md:ml-64">
    ...
    <header class="bg-white shadow-sm px-6 py-4 flex items-center justify-between">
      ...
      <h1 class="text-xl font-semibold">@yield('titulo','Dashboard')</h1>
    </header>
